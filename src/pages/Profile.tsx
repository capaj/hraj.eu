          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600 text-sm mt-1">Events you're organizing or participating in</p>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600 text-sm mt-1">Events you've saved for later</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {savedEvents.length > 0 ? (
                    savedEvents.map((event) => renderEventCard(event, true, true))
                  ) : (
                    renderEmptyState(
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600 text-sm mt-1">Your sports history and achievements</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {pastEvents.length > 0 ? (
                    ...
                    renderEmptyState(
                      ...
                      <Button variant="outline" size="sm">Join Your First Event</Button>
                    )
                  )}
                </div>
              </CardContent>
